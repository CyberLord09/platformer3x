  ...
  */
  ...
  assets: {
    ...
    platforms: {
      ...
      greektriangle: { src: "/images/platformer/platforms/greektriangle.png" },
      greekpillar: { src: "/images/platformer/platforms/greekpillar.png" },      
...
//{ name: 'sandstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.sandstone, xPercentage: 0.6, yPercentage: 0.28 },
  ...
  //    { name: 'sandstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.sandstone, xPercentage: 0.6368, yPercentage: 0.64 },
      ...
      { name: 'greektriangle', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.greektriangle, xPercentage: 0.75, yPercentage: 1 },
    //  { name: 'greekpillar', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.greekpillar, xPercentage: 0.75, yPercentage: 0.94 },
      ...
      //{ name: 'greektriangle', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.greektriangle, xPercentage: 0.75, yPercentage: 0.82 },
      { name: 'greekpillar', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.greekpillar, xPercentage: 0.75, yPercentage: 0.76 },
      ...
      { name: 'greektriangle', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.greektriangle, xPercentage: 0.75, yPercentage: 0.64 },
      //{ name: 'greekpillar', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.greekpillar, xPercentage: 0.75, yPercentage: 0.58 },
