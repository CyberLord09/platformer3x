...
export class Player extends Character {
    ...
    collisionAction() {
        ...
        if (this.collisionData.touchPoints.other.id === "goomba" || this.collisionData.touchPoints.other.id === "flyingGoomba" || this.collisionData.touchPoints.other.id === "flyingUFO" || this.collisionData.touchPoints.other.id === "alien" || this.collisionData.touchPoints.other.id === "boss" ) {
